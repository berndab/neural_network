...
A neural network machine learning model was created to predict if a project associated with a grant requet  will be successful. This model will be trained and tested on a data set that contains information about the type of philanthropic organizations, the types of projects that these organization have managed, the size of the grants issued to fund these projects, and the outcome of these projects. When evaluating future grant proposals, the neural network model will use the features that describe philanthropic organization type, the project type, and the amount requesting in the grant proposal, to predict the outcome of the project. 
